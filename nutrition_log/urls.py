...
urlpatterns = [
    ...
    path('set_weight/<int:year>/<int:month>/<int:day>/', views.set_weight, name='set_weight'),
    path('log_food_item/<int:year>/<int:month>/<int:day>/', views.log_food_item, name='log_food_item'),
